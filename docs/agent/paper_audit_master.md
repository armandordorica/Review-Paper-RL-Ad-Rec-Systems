...
| 4.5 Exploration/Exploitation | ~860-1050  | `exploration_exploitation_audit.md` | **7.2 / 10**           | Fair / Fair–Poor / Fair           | mechanical + equation/RegCB framing fixed; E15 industry-claim misalignment fixed (line 880 rewritten to `tang2013ad`/`agarwal2014budget`/`gao2022bidding` synthesis); no open P0/P1 citation defect; open P1: ad-policy reframing E1-E3, line-878 over-claim E16 |
