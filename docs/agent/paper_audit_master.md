...
Latest refresh: May 24, 2026 (late evening). Built after the reviewer-context recalibration in the history-audit refresh confirmed that the H11 compression was reviewer-misaligned and reverted.
...
| 4.0 RL Formulation opener    | 291-322   | **MISSING**                         | n/a                    | Fair / Fair / Poor                | open a `rl_formulation_opener_audit.md`     |
...
| Acknowledgments              | 1113-1115 | **MISSING**                         | n/a                    | Poor (AE flag) / n/a / n/a        | one-line cleanup; no audit file needed      |
...
| **Reviewer 2**       | Major Revision | **Major Revision (held)**    | *"it would be better to have a separate subsection introducing the RL task (eg: formulating as MDP, etc) with the necessary notations. Include a table of notation if possible"*                                                                                                 | Section 4.0 opener           |
...
Reviewer 2's hold is driven by one named specific ask that has not been addressed: the MDP intro subsection + notation table.
...
## Recommended Next Action Plan (5-Move Sequence)

This is the leverage-optimized sequence for the next revision cycle. Each move is sized for a single working session and ordered so that the most reviewer-recommendation-changing work happens first.


| #   | Move                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Target reviewer   | Estimated impact                                                                                                                                                                 | Audit follow-up                                                                            |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| 1   | **Rewrite Acknowledgments to standard impersonal form**, removing the "thanking the second author for the guidance" phrasing.                                                                                                                                                                                                                                                                                                                               | AE                | Defuses one of AE's three named complaints. Cheapest visible win in the paper.                                                                                                   | none                                                                                       |
| 2   | **Add Section 4.0 MDP-formulation opener** (joint ad+organic MDP definition, notation table for $s_t, a_t, r_t, \pi, \gamma, P$, mapping each symbol to its ad-policy meaning, brief paragraph on partial observability and policy-induced shift). Reference forward to Sections 4.1-4.5.                                                                                                                                                                   | R2                | Removes R2's single named specific ask. Likely moves R2 toward minor revision or accept.                                                                                         | open `rl_formulation_opener_audit.md`                                                      |
| 3   | **Build the dedicated Evaluation section** between current Sections 4 and 5. Cover: A/B testing in industrial ad systems, offline replay with IPS and doubly-robust estimators, simulator-based testing including RecSim and RecoGym, KPI inventory (CTR, CVR, RPM, ad load, dwell, return rate), and a comparative results table quoting magnitudes from already-cited industrial studies (TikTok DEAR, YouTube SlateQ, Meta Horizon, Pinterest TransAct). | R1 + AE           | Closes R1 Major 3 + Theoretical Evaluation, which together are the binding constraint on Reviewer 1's upgrade from Major Revision to Accept. Closes AE's evaluation-aspects ask. | open `evaluation_audit.md`; close H23                                                      |
