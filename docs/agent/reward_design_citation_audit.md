...
- <span style="background:#fd7e14;color:white;padding:2px 8px;border-radius:4px;font-weight:bold">P2</span> <span style="background:#198754;color:white;padding:2px 8px;border-radius:4px;font-weight:bold">DONE (May 30)</span> **R4.** Standardized the duplicate long-term experimentation citation keys. Confirmed `43887` and `hohnhold2015focusing` are the same Hohnhold/O'Brien/Tang 2015 KDD paper (identical author triple and venue). The single `43887` use at the proxy-metrics paragraph was switched to `hohnhold2015focusing`, and the duplicate `43887` bib entry was removed.
