...
- <span style="background:#7c1d1d;color:white;padding:2px 8px;border-radius:4px;font-weight:bold">P0</span> <span style="background:#198754;color:white;padding:2px 8px;border-radius:4px;font-weight:bold">DONE</span> **H7.** Removed the generic AlexNet / neural-network breakthrough material and rewrote the deep-learning transition around industrial ad/recsys representation learning, including deep retrieval/ranking models and two-tower architectures. The replacement explains that better representations improve pointwise prediction but do not solve reward-design or policy-learning challenges.
- <span style="background:#dc3545;color:white;padding:2px 8px;border-radius:4px;font-weight:bold">P1</span> <span style="background:#198754;color:white;padding:2px 8px;border-radius:4px;font-weight:bold">DONE</span> **H9 + H10.** Removed the speculative multi-head attention example and the generic attention-head selection paragraph. The revised Section 3.2 now mentions sequential encoders only to explain how user histories and evolving interests improve state representation, then returns to the unresolved ad-policy problem.
