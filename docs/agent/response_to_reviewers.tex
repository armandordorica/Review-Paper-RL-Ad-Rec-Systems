...
\item \textbf{Clear problem definition early.} A new subsection 4.1
  ...
  jointly: we make the joint formulation explicit, defining the action space as
  the union of the ad and organic candidate sets.
...
\item \textbf{New, dedicated evaluation section (Section 5).} It covers metric
  roles (primary, secondary, and guardrail KPIs), offline replay and counterfactual
...
\noindent Armando Ordorica and Yuri Lawryshyn
