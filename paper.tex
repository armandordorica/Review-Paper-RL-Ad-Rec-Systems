...
\begin{tabularx}{\linewidth}{p{0.12\linewidth} p{0.23\linewidth} p{0.42\linewidth} p{0.17\linewidth}}
% the decimal points allow to control the size of the table, not of the text.
\toprule
{\bfseries Objective} & {\bfseries Proxy Metric} & {\bfseries Short Description} & {\bfseries Polarity} \\
\midrule
    \multirow{5}{*}{\textbf{Revenue}} 
       & \textbf{CTR (Click-Through Rate)} 
           ...
           & \textbf{Positive} (higher better) \\
       & \textbf{Ad Impressions} 
           & Number of times an ad is displayed to users. 
           & \textbf{Mixed} (depends on user tolerance and ad load) \\
    ...
    \multirow{12}{*}{\textbf{Engagement}} 
       ...
       & \textbf{Mixed threshold}: short clicks/views ($<5$s) negative; long clicks/views ($\geq10$s) positive \\
       & \textbf{Shares} 
    ...
    & \textbf{Ratio-based Diversity}  
           ...
           & \textbf{Mixed} (too low or too high can be harmful) \\
     ...
     & \textbf{Repeated Consumption}  
           ...
           & \textbf{Mixed} (moderate repetition good; excessive repetition may reduce novelty) \\
           ...
           & \textbf{Negative} (lower is better) \\
     & \textbf{Distribution-based Diversity}  
           ...
           & \textbf{Mixed} (target range, not monotonic) \\
    ...
    \multirow{6}{*}{\textbf{Ad Fatigue}} 
       ...
       & \textbf{Ad Load (Absolute)} 
           ...
           & \textbf{Negative} (higher is usually worse) \\
       & \textbf{Click Entropy} 
           ...
           & \textbf{Negative} (higher often worse relevance) \\
\bottomrule
\end{tabularx}
\caption{Proxy metrics for Revenue, Engagement, and Ad Fatigue.}
