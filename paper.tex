...
\begin{table*}[!t]
    ...
    \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.15\textwidth}>{\raggedright\arraybackslash}p{0.23\textwidth}>{\raggedright\arraybackslash}X@{}}
        ...
        Goal & $\max_\pi \mathbb{E}_\pi[\sum_{t=0}^{T}\gamma^tR_t]$ & Learn a policy that improves monetization while preserving engagement, retention, and user-experience guardrails over repeated interactions. \\
        ...
        Exploration and logging & $\epsilon$, UCB, Thompson sampling, or $\mu(a\mid s)$ & The mechanism that generates evidence about uncertain actions, either through deliberate exploration or through the historical logging policy used for offline replay. \\
        \bottomrule
    \end{tabularx}
